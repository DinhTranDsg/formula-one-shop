...
export const astonMartinProducts: Product[] = [
    ...
    },
    {
        id: 2,
        name:
            "Aston Martin Aramco Cognizant F1 2025 Fernando Alonso Team Driver T-Shirt",
    ...
    },
    {
        id: 4,
        name:
            "Aston Martin Aramco Cognizant F1 2025 Fernando Alonso Team Cap - Green",
    ...
    },
    {
        id: 8,
        name:
            "Aston Martin F1 Team AMR24 No.14 2024 - Fernando Alonso 1:64 Model",
...
export function getAstonMartinProductById(id: number): Product | undefined {
    return astonMartinProducts.find((p) => p.id === id);
}
