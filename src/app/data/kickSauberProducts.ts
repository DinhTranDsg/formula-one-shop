...
export const kickSauberProducts: Product[] = [
    {
        id: 1,
    ...
    },
    {
        id: 9,
        name:
            "Alfa Romeo Sauber F1 Team Stake C43 No.77 Valtteri Bottas 1:64 Model",
...
export function getKickSauberProductById(id: number): Product | undefined {
    return kickSauberProducts.find((p) => p.id === id);
}
