...
export default function FormulaOneProductDetailPage({ params }: PageProps) {
    ...
    const alsoLike: FormulaOneProduct[] = formulaOneProducts
        ...
        <div className="bg-white pb-16">
            <div className="mx-auto max-w-[1450px] px-8">
                ...
                <div className="py-4 text-xs text-gray-500">
                    <Link href="/teams/formula-one" className="hover:underline">
                        Formula 1
                    </Link>{" "}
                    /{" "}
