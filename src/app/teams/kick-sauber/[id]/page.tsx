// src/app/teams/kick-sauber/[id]/page.tsx
"use client";
...
export default function KickSauberProductDetailPage({ params }: PageProps) {
    // ✅ Lấy id trực tiếp từ params
    const idNumber = Number(params.id);

    const product = getKickSauberProductById(idNumber);
    ...
    // 4 sản phẩm gợi ý phía dưới
    const alsoLike: Product[] = kickSauberProducts
        ...
        <div className="bg-white pb-16">
            <div className="mx-auto max-w-[1450px] px-8">
                ...
                <div className="py-4 text-xs text-gray-500">
                    <Link href="/teams/kick-sauber" className="hover:underline">
                        Kick Sauber
                    </Link>{" "}
                    /{" "}
                    <span className="hover:underline">
                        Kick Sauber Teamwear
                    </span>
                </div>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="grid max-w-xs grid-cols-3 gap-2">
                                {SIZES.map((size) => {
                                    ...
                                    const isDisabled = size === "XS"; // cho giống UI: XS mờ
