...
const drivers = ["Ayrton Senna", "Lando Norris", "Oscar Piastri"];
...
function getColourDotClass(value: string): string {
    ...
    switch (v) {
        ...
        case "blue":
            return "bg-blue-600";
        case "camo":
            return "bg-gradient-to-br from-green-700 via-brown-700 to-green-900";
        case "light pink":
            return "bg-pink-200";
        case "navy":
            return "bg-slate-900";
                ...
                <div className="flex gap-6">
                    ...
                    <section className="flex-1">
                        <div className="mb-4 flex items-center justify-between text-xs text-gray-700">
                            ...
                            <span>1 - 72 of 143</span>
                        </div>

                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                            {mclarenProducts.map((p: Product) => (
                                <Link
                                    key={p.id}
                                    href={`/teams/mclaren/${p.id}`}
