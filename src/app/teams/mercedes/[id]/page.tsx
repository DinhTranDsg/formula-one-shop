...
export default function MercedesProductDetailPage({ params }: PageProps) {

    const resolvedParams = use(params);
    const idNumber = Number(resolvedParams.id);

    const product = getMercedesProductById(idNumber);
    ...
    const alsoLike: Product[] = mercedesProducts
        ...
        <div className="bg-white pb-16">
            <div className="mx-auto max-w-[1450px] px-8">
                ...
                <div className="py-4 text-xs text-gray-500">
                    <Link href="/teams/mercedes" className="hover:underline">
                        Mercedes
                    </Link>{" "}
                    /{" "}
                    <span className="hover:underline">
                        Mercedes Hoodies &amp; Sweatshirts
                    </span>
                </div>
                ...
                <div className="grid grid-cols-[minmax(0,0.6fr)_minmax(0,0.4fr)] gap-12">
                    ...
                    <div>
                        ...
                        <p className="mt-1 text-xs text-gray-500">by adidas</p>
