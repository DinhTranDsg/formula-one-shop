...
import {
    getRedBullProductById,
    redBullProducts,
    type Product,
} from "@/data/redBullProducts";
...
export default function RedBullProductDetailPage({ params }: PageProps) {
    const resolvedParams = use(params);
    const idNumber = Number(resolvedParams.id);

    const product = getRedBullProductById(idNumber);
    ...
    const alsoLike: Product[] = redBullProducts
        ...
        <div className="bg-white pb-16">
            <div className="mx-auto max-w-[1450px] px-8">
                <div className="py-4 text-xs text-gray-500">
                    <Link href="/teams/red-bull" className="hover:underline">
                        Red Bull
                    </Link>{" "}
                    /{" "}
                    <span className="hover:underline">
                        Red Bull Hoodies &amp; Sweatshirts
                    </span>
                </div>
