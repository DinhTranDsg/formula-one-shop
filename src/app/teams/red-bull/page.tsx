...
const drivers = ["Max Verstappen", "Sergio Perez", "Yuki Tsunoda"];
...
export default function RedBullTeamwearPage() {
    return (
        <div className="bg-white">
            ...
            <div className="mx-auto max-w-[1500px] px-6 pb-12">
                <div className="relative mb-8 bg-black">
                    <Image
                        src="https://f1store.formula1.com/content/ws/all/86f52067-a722-4199-b873-55460ad11dab__1370X450.png"
                        alt="Red Bull driver"
                        width={1370}
                        height={450}
