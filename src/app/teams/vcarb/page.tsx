...
import { vcarbProducts, type VcarbProduct } from "@/data/vcarbProducts";

type Product = VcarbProduct;
...
const drivers = ["Isack Hadjar", "Liam Lawson"];
...
const brands = ["Hugo Boss", "LEGO", "New Era"];

const colours = ["White", "No Color", "Blue"];
...
export default function VCARBTeamwearPage() {
    const products: Product[] = vcarbProducts;
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                            {products.map((p) => (
                                ...
                                >
                                    ...
                                    {p.note && (
                                        <p className="mt-1 text-xs text-red-500">{p.note}</p>
                                    )}
