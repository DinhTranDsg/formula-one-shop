...
import {
    williamsProducts,
    getWilliamsProductById,
    type Product,
} from "@/data/williamsProducts";
...
export default function WilliamsProductDetailPage({ params }: PageProps) {
    const { id } = use(params);
    const idNumber = Number(id);

    const product = getWilliamsProductById(idNumber);
    ...
    const alsoLike: Product[] = williamsProducts
        ...
        <div className="bg-white pb-16">
            <div className="mx-auto max-w-[1450px] px-8">
                <div className="py-4 text-xs text-gray-500">
                    <Link href="/teams/williams" className="hover:underline">
                        Williams
                    </Link>{" "}
                    /{" "}
                    <span className="hover:underline">
                        Williams Hoodies &amp; Teamwear
                    </span>
                </div>
